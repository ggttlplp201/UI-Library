 ...
 * Ported from React Bits (RotatingText-TS-TW) via its shadcn-compatible registry.
 ...
 * `ref` is accepted as a plain prop, per React 19 semantics.)
 */
