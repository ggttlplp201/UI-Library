/**
 * FamilyButton — Button component with family-style design and interactive hover effects
 * Ported from Cult UI (family-button) via its shadcn-compatible registry.
 * Source: https://www.cult-ui.com/docs/components/family-button
