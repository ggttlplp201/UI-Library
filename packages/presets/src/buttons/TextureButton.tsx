/**
 * TextureButton — Button component with texture overlay effects and customizable variants
 * Ported from Cult UI (texture-button) via its shadcn-compatible registry.
