/**
 * GlassSocialButtons — grid of frosted-glass social icon buttons with a
 * sheen sweep, tilt and colored glow per network on hover (Tailwind).
 * Ported from UIverse.io (shaggy-eel-44) by Itskrish01.
 * Source: https://uiverse.io/Itskrish01/shaggy-eel-44
 * License: MIT. Attribution: Itskrish01 via UIverse.io.
 */
export const GlassSocialButtons = ({
  columns = 2,
  gap = 24,
}: {
