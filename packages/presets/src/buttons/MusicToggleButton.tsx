...
/**
 * Music toggle with a live waveform visualization.
 * Ported from Skiper UI (skiper25) — Author: @gurvinder-singh02 (https://gxuri.me).
...
export const MusicToggleButton = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-background border-border cursor-pointer rounded-full border p-2"
    >
      <motion.div
