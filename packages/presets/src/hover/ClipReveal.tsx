...
/**
 * Rounded-blob clip-path image panel; the image zooms on hover.
 * Ported from Skiper UI (skiper66) — Author: @gurvinder-singh02 (https://gxuri.me).
 * Attribution to Skiper UI is required when using the free version.
 */
export const ClipDiv = ({
  children,
  imgSrc = "/images/lummi/img14.jpg",
  className,
}: {
  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          "group relative flex aspect-video w-[420px] items-center justify-center overflow-hidden",
          className,
        )}
      >
        <img
        ...
        <div className="absolute">
          {children ?? (
            <h1 className="text-4xl font-semibold text-white">Hover Me</h1>
          )}
        </div>
      </div>
    </>
