...
/**
 * Crowd of walking Open Peeps on a canvas.
 * Ported from Skiper UI (skiper39), adapted from https://codepen.io/zadvorsky/pen/xxwbBQV;
 * illustrations by https://www.openpeeps.com/.
...
interface CrowdCanvasProps {
  /** Sprite sheet of walking characters */
  src?: string;
  rows?: number;
  cols?: number;
}
...
const CrowdCanvas = ({ src = "/images/peeps/all-peeps.png", rows = 15, cols = 7 }: CrowdCanvasProps) => {
  ...
  return (
    <div className="relative h-[320px] w-[560px] max-w-full overflow-hidden">
