...
/**
 * media-chrome video player kit + a cursor-follow "Play" popover demo.
 * Ported from Skiper UI (skiper67) — Author: @gurvinder-singh02 (https://gxuri.me).
...
export const VideoPopOverDemo = ({
  ...
  return (
    <section data-hover-demo="pointer" className="relative flex h-[360px] w-[480px] max-w-full items-center justify-center rounded-xl border border-border bg-[#f5f4f3]">
      <div className="absolute top-8 grid content-start justify-items-center gap-6 text-center">
      ...
      <div
        ...
        className="size-45 overflow-hidden rounded-2xl"
      >
        <motion.div
          style={{ x, y, opacity }}
