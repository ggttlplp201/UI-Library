/**
 * DynamicIsland — iOS-style dynamic island component with expandable content and smooth animations
 * Ported from Cult UI (dynamic-island) via its shadcn-compatible registry.
