...
/**
 * Dynamic-island style expanding toggle pill.
 * Ported from Skiper UI (skiper3) — Author: @gurvinder-singh02 (https://gxuri.me).
 * Attribution to Skiper UI is required when using the free version.
 */
export const DynamicIslandToggle = () => {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-foreground/8 rounded-full px-7 py-1 active:scale-95"
      >
        Toggle
      </button>
    </div>
