...
/**
 * Theme toggle with View Transition API reveal animations (circle / rectangle
 * / polygon / gif wipes).
 * Ported from Skiper UI (skiper26), original concept by rudrodip
...
/**
 * Composed demo: the toggle wrapped in its own next-themes provider so the
 * view-transition theme flip works standalone.
 */
export const ThemeToggleViewTransition = ({
  variant = "circle",
  start = "center",
  blur = false,
  /** GIF used by the "gif" variant's reveal mask */
  gifUrl = "",
}: {
  variant?: AnimationVariant;
  start?: AnimationStart;
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="light">
      <div
        className="flex min-h-[140px] min-w-[200px] items-center justify-center rounded-xl border border-border bg-background p-8"
