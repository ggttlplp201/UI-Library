/**
 * GlowFlipCard — card with a rotating glow border on its cover that flips
 * over in 3D on hover to reveal content over floating blurred blobs.
 * Ported from UIverse.io (tricky-robin-67) by ElSombrero2.
 * Source: https://uiverse.io/ElSombrero2/tricky-robin-67
 * License: MIT. Attribution: ElSombrero2 via UIverse.io.
 */
import type { CSSProperties } from "react";

export const GlowFlipCard = ({
  backText = "Hover Me",
  badge = "Pasta",
  ...
  /** Text on the cover face */
  backText?: string;
  /** Small badge label on the front */
  badge?: string;
  /** Front title */
  title?: string;
  /** Footer meta text */
  meta?: string;
  /** Rotating border glow color */
  glow?: string;
}) => (
  <>
    <style>{`
      ...
      .uv-gfc-back::before {
        ...
        width: 160px;
        height: 160%;
        background: linear-gradient(90deg, transparent, var(--uv-gfc-glow), var(--uv-gfc-glow), var(--uv-gfc-glow), var(--uv-gfc-glow), transparent);
        animation: uv-gfc-rotation 5000ms infinite linear;
      }
      .uv-gfc-back-content {
        position: absolute;
        width: 99%;
      ...
      .uv-gfc-card:hover .uv-gfc-content {
        transform: rotateY(180deg);
      }
      @keyframes uv-gfc-rotation {
        0% {
      ...
      .uv-gfc-front .uv-gfc-front-content {
        position: absolute;
        width: 100%;
        height: 100%;
        padding: 10px;
      ...
      .uv-gfc-front-content .uv-gfc-badge {
      ...
      .uv-gfc-circle {
        ...
        position: relative;
        filter: blur(15px);
        animation: uv-gfc-floating 2600ms infinite linear;
      }
      .uv-gfc-circle-bottom {
    ...
    `}</style>
    <div
      className="uv-gfc-card"
      style={{ "--uv-gfc-glow": glow } as CSSProperties}
    >
      <div className="uv-gfc-content">
        <div className="uv-gfc-back">
          <div className="uv-gfc-back-content">
        ...
        <div className="uv-gfc-front">
          <div className="uv-gfc-img">
            <div className="uv-gfc-circle"></div>
            <div className="uv-gfc-circle uv-gfc-circle-right"></div>
            <div className="uv-gfc-circle uv-gfc-circle-bottom"></div>
          </div>
          <div className="uv-gfc-front-content">
            <small className="uv-gfc-badge">{badge}</small>
            <div className="uv-gfc-description">
              <div className="uv-gfc-title">
                <p className="uv-gfc-title">
                  <strong>{title}</strong>
                </p>
                <svg fillRule="nonzero" height="15px" width="15px" viewBox="0,0,256,256" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                  <g style={{ mixBlendMode: "normal" }} fontSize="none" fontWeight="none" fontFamily="none" strokeDashoffset="0" strokeDasharray="" strokeMiterlimit="10" strokeLinejoin="miter" strokeLinecap="butt" strokeWidth="1" stroke="none" fillRule="nonzero" fill="#20c997">
              ...
              <p className="uv-gfc-card-footer">{meta}</p>
            </div>
          </div>
        </div>
      </div>
