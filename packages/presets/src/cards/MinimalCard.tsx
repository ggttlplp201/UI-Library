/**
 * MinimalCard — Clean and minimal card component with subtle styling and hover effects
 * Ported from Cult UI (minimal-card) via its shadcn-compatible registry.
 * Source: https://www.cult-ui.com/docs/components/minimal-card
 * Author: nolly-studio (@cult-ui). License: MIT.
 * (forwardRef unwrapped for the Studio's AST edit engine — no other change.
 *  Unused `next/image` import dropped — the component already renders a plain <img>.)
 */
